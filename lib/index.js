...
var WaterChart = function WaterChart(options) {
    ...
    var _options = _extends({}, options),
        ...
        maxValue = _options$maxValue === undefined ? 200 : _options$maxValue,
        ...
        strokeWidth = _options$strokeWidth === undefined ? 10 : _options$strokeWidth,
        ...
        textUnit = _options.textUnit,
        _options$textUnitSize = _options.textUnitSize,
        textUnitSize = _options$textUnitSize === undefined ? '18px' : _options$textUnitSize,
    ...
    var textCountAnimate = function textCountAnimate(target) {
        ...
        var finalValue = void 0,
            startValue = textIsAnimate ? _this.prevValue === 0 ? minValue : _this.prevValue : series[0];
        ...
        target.text((textIsPercent ? startValue * 100 : startValue).toFixed(accuracy)).attr('font-size', fontSize).attr('transform', 'translate(' + cx + ',' + textScaleY(textPositionY) + ')');
